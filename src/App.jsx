...
import trips from "./data/cuenca_event.json"
import redes from "./data/cuenca_net.json"
  ...
  return (
    ...
    <div className=''>
      ...
      <div className="flex items-center right" >
        <h1>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#0c0c0cd0" transform="matrix(1, 0, 0, 1, 0, 0)" width="100" height="100">
            <defs>
              <style>
                {`
                  .cls-1 {
